...
"""autogenerated by genpy from whole_body_state_msgs/JointState.msg. Do not edit."""
import codecs
import sys
...
class JointState(genpy.Message):
  _md5sum = "b5c92fc99c5d79e265770c8ce99bf79f"
  _type = "whole_body_state_msgs/JointState"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# This message describes the state of an actuated joints.
#
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,position,velocity,acceleration,effort
